...
public class ShreyasProfile {
    ...
    public static void main(String[] args) {
        ...
        shreyas.addCurrentFocus("Advanced DSA for problem-solving");
        
        shreyas.setLookingFor(List.of("Full-time Roles", "Internships", "Open Source"));
